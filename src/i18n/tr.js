...
export const t = {
  ...
  pricing: {
    ...
    title: 'İşletmenize Uygun Plan Seçin',
    subtitle: '14 gün boyunca tüm özellikleri ücretsiz deneyin. Kredi kartı gerekmez.',
    monthly: 'Aylık',
    yearly: 'Yıllık',
    discount: '%20 İndirim',
    perMonth: '/ay',
    ...
    talkSales: 'Satış Ekibiyle Görüşün',
    plans: [
      { name: 'Başlangıç', desc: 'Küçük işletmeler için ideal', personel: '1–15 personel' },
      { name: 'Profesyonel', desc: 'Büyüyen ekipler için en popüler', personel: '16–50 personel', badge: 'En Popüler' },
      { name: 'Kurumsal', desc: 'Büyük ölçekli organizasyonlar için', personel: '50+ personel' },
    ],
    features: [
      'QR Kod Giriş/Çıkış',
      'GPS Konum Doğrulama',
    ...
    faqs: [
      ...
      { q: 'Sözleşme zorunluluğu var mı?', a: 'Hayır. Aylık planlarda istediğiniz zaman iptal edebilirsiniz.' },
      { q: 'Fatura kesiliyor mu?', a: 'Evet. Her ödeme döneminde e-Fatura kesilir.' },
      { q: 'Paket değiştirilebilir mi?', a: 'Evet. Paketinizi istediğiniz zaman yükseltebilir veya düşürebilirsiniz.' },
    ],
    ctaTitle: 'Hangi Paket Size Uygun?',
    ctaDesc: 'Kararsız mısınız? Ekibimize yazın, işletmenize en uygun çözümü birlikte belirleyelim.',
    ctaBtn: 'Ücretsiz Danışmanlık Alın',
  },
  ...
  testimonials: {
    ...
    items: [
      {
        quote: 'Shiftlap öncesinde Excel tablolarıyla uğraşıyorduk. Şimdi ay sonu puantajı hazırlamak 5 dakikamızı alıyor.',
        name: 'Mehmet Y.',
        role: 'İK Müdürü',
  ...
  blog: {
    badge: 'Shiftlap Blog',
    title: 'PDKS ve Personel Yönetimi Hakkında',
    subtitle: 'İşletmenizi modernleştirmek için bilmeniz gereken her şey.',
    readMore: 'Devamını Oku',
    readTime: 'dk okuma',
    allPosts: 'Tüm Yazılar',
    notFound: 'Yazı Bulunamadı',
    notFoundDesc: 'Aradığınız blog yazısı mevcut değil veya henüz yayınlanmamış.',
    backToBlog: "Blog'a Dön",
    tryFree: "Shiftlap'ı Ücretsiz Deneyin",
    tryFreeDesc: '14 gün boyunca tüm özellikleri ücretsiz kullanın. Kredi kartı gerekmez.',
    startNow: 'Hemen Başlayın',
    relatedPosts: 'Diğer Yazılar',
    emptyState: 'Henüz yayınlanmış bir yazı bulunmuyor.',
    seoTitle: 'Blog | Shiftlap — PDKS ve Personel Yönetimi Yazıları',
    seoDesc: 'PDKS, personel takibi, vardiya yönetimi ve İK teknolojileri hakkında güncel yazılar.',
  },
